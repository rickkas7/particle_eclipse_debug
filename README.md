...
![Setting libusbk driver for STM32 STLink device](images/stlink-zadig.png)
...
![Particle Programmer Shield](images/progshield.jpg)
...
![Zadig settings for Particle Programmer Shield](images/programmer-zadig.png)
...
In this example I created a new  directory in src called "tinkerbreak" that contains [tinkerbreak.cpp](files/tinkerbreak.cpp), a modified version of tinker that responds to the Particle function "break" to break into the debugger under software control.

![src directory layout](images/srcdir.png)
...
![Extract All](images/eclipse-extract-win.png)
...
![Add Software](images/eclipse-add-1.png)

- In the Add Repository window, enter **GNU ARM Eclipse** for the **Name** and click **OK**.

![Add Software](images/eclipse-add-2.png)

- Select the packages

![Add Software](images/eclipse-add-3.png)
...
![Unsigned Content Warning](images/eclipse-add-4.png)
...
If you are using the Particle Programmer Shield, you will need to copy the configuration file. Download [particle-ftdi.cfg](files/particle-ftdi.cfg) and copy it into your OpenOCD installation directory, into **scripts/ftdi/particle-ftdi.cfg**.
...
![Eclipse New Project](images/eclipse-new-project-1.png)
...
![Eclipse New Project](images/eclipse-new-project-2.png)

- Download [Makefile](files/Makefile) and save it into your project directory. 
...
![Project Properties](images/settings-4.png)
...
![Environment Properties Windows](images/settings-5.png)
...
![Environment Properties Mac](images/settings-7.png)
...
![Environment Properties Linux](images/settings-6.png)
...
![Error Configuration](images/code-analysis.png)
...
![Debug Configuration](images/debug-1.png)
...
![New Debug Configuration](images/debug-2.png)
...
![Debug Main Configuration](images/debug-3.png)
...
![Debug Target Configuration](images/debug-4.png)
...
![Debug History](images/debug-6.png)

- Click **Yes** to switch to a Debug perspective.

![Debug History](images/debug-8.png)
...
![Debug Consoles](images/debug-5.png)
...
![Debug Break](images/debug-10.png)
...
![Setting breakpoint](images/debug-11.png)
...
![Hit breakpoint](images/debug-12.png)
...
![Hit breakpoint](images/debug-13.png)
...
![Perspective Selector](images/debug-14.png)
...
![Electron platform](images/settings-8.png)
...
![Settings for P1](images/settings-9.png)
